...
class EnergyMeterMQTTClient:
    def __init__(self, broker_address,port,username,password,topic):
...
if __name__ == "__main__":
    ...
    port =1883
    username = "prathaban"
    password = "123prathaban123"
    topic = "testtopic/740"
    #client_id="clientId-JZnMXefu2U"

    mqtt_client = EnergyMeterMQTTClient(broker_address,port,username,password,topic)
    mqtt_client.connect()
    mqtt_client.start()
